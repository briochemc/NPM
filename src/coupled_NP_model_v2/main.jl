...
PO₄, POP, DIN, PON = unpack_tracers(s_optimized,grd)
uptake_P_optimized = uptake_P(PO₄,DIN,p_optimized)
...
BSON.@save joinpath(data_path, "optimized_data_for_plots.bson") PO₄ POP DIN PON uptake_P_optimized remin_P_optimized remin_N_optimized fixation_optimized denit_optimized
